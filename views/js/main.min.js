...
a.innerHTML=randomName();d.appendChild(a);a=document.createElement("ul");a.innerHTML=makeRandomPizza();d.appendChild(a);b.appendChild(d);return b},resizePizzas=function(a){window.performance.mark("mark_start_resize");a:switch(a){case "1":document.querySelector("#pizzaSize").innerHTML="Small";break a;case "2":document.querySelector("#pizzaSize").innerHTML="Medium";break a;case "3":document.querySelector("#pizzaSize").innerHTML="Large"}for(var b=0,c=document.querySelectorAll(".randomPizzaContainer"),
e=c.length;b<e;b++){var d=a,f=c[b].offsetWidth,h=document.querySelector("#randomPizzas").offsetWidth,f=f/h,g=void 0;a:{switch(d){case "1":g=.25;break a;case "2":g=.3333;break a;case "3":g=.5;break a}g=void 0}c[b].style.width=c[b].offsetWidth+(g-f)*h+"px"}window.performance.mark("mark_end_resize");window.performance.measure("measure_pizza_resize","mark_start_resize","mark_end_resize");a=window.performance.getEntriesByName("measure_pizza_resize");console.log("Time to resize pizzas: "+a[0].duration+
"ms")};window.performance.mark("mark_start_generating");for(var i=2;100>i;i++){var pizzasDiv=document.getElementById("randomPizzas");pizzasDiv.appendChild(pizzaElementGenerator(i))}window.performance.mark("mark_end_generating");window.performance.measure("measure_pizza_generation","mark_start_generating","mark_end_generating");var timeToGenerate=window.performance.getEntriesByName("measure_pizza_generation");console.log("Time to generate pizzas on load: "+timeToGenerate[0].duration+"ms");
var frame=0;function logAverageFrame(a){for(var b=a.length,c=0,e=b-1;e>b-11;e--)c+=a[e].duration;console.log("Average time to generate last 10 frames: "+c/10+"ms")}
function updatePositions1(){frame++;var a,b=0;window.performance.mark("mark_start_frame");for(var c=document.querySelectorAll(".mover"),e=c.length;b<e;b++)a=Math.sin(scrollTopPosition/1250+b%5),c[b].style.transform="translateX("+100*a+"px)";window.performance.mark("mark_end_frame");window.performance.measure("measure_frame_duration","mark_start_frame","mark_end_frame");0===frame%10&&(a=window.performance.getEntriesByName("measure_frame_duration"),logAverageFrame(a))}
